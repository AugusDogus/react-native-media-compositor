///
/// MediaCompositorNormalizedRect.hpp
...
namespace margelo::nitro::mediacompositor {
  ...
  /**
   * A struct which can be represented as a JavaScript object (MediaCompositorNormalizedRect).
   */
  struct MediaCompositorNormalizedRect final {
  public:
  ...
  public:
    MediaCompositorNormalizedRect() = default;
    explicit MediaCompositorNormalizedRect(double x, double y, double width, double height): x(x), y(y), width(width), height(height) {}

  public:
    friend bool operator==(const MediaCompositorNormalizedRect& lhs, const MediaCompositorNormalizedRect& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ MediaCompositorNormalizedRect <> JS MediaCompositorNormalizedRect (object)
  template <>
  struct JSIConverter<margelo::nitro::mediacompositor::MediaCompositorNormalizedRect> final {
    static inline margelo::nitro::mediacompositor::MediaCompositorNormalizedRect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::mediacompositor::MediaCompositorNormalizedRect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::mediacompositor::MediaCompositorNormalizedRect& arg) {
